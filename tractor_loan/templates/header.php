...
<body class="blue">
    ...
    <div class="main-nav">
      <a href="/Farmer_loaning_v2/tractor_loan/tractorloan.php" class="brand-text " style="margin-left:100px;">Machinary Loan </a>
      <ul class="push" >
        <li><a href="/Farmer_loaning_v2/tractor_loan/ad.php" class="btn brand z-depth-0">Apply for a Loan</a></li>
