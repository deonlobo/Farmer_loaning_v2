...
<body class="blue">
    ...
    <div class="main-nav">
      <a href="/Farmer_loaning_v2/dairy_loan/dairyloan.php" class="brand-text " style="margin-left:100px;">Dairy Loan </a>
      <ul class="push" >
        <li><a href="/Farmer_loaning_v2/dairy_loan/loans/dairy.php" class="btn brand z-depth-0">Apply for a Loan</a></li>
