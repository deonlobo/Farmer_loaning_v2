<?php 
	...
	$sql = "SELECT * FROM LOAN L,BORROW BR,BANK B 
	        WHERE L.LoanID=BR.LoanID AND BR.BankID=B.BankID AND Lstatus='Pending' AND Approve='Approved' AND BR.LoanType='Crop Loan'
...
<html>
	...
	<div class="container">
		<div class="row">
			...
			<?php }else {?>
				      <h4 class="center lightgrey" style="margin-top:50px;margin-bottom: 50px;">No Crop Loans Applied</h4>
		    <?php }?>
