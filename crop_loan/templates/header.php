...
<body class="blue">
    ...
    <div class="main-nav">
      <a href="/Farmer_loaning_v2/crop_loan/croploan.php" class="brand-text " style="margin-left:100px;">Crop Loan </a>
      <ul class="push" >
        <li><a href="/Farmer_loaning_v2/crop_loan/loans/crop.php" class="btn brand z-depth-0">Apply for a Loan</a></li>
